...
def main(args):
    ...
    if args.channel == "tt":
        ...
        plot_vars = [
            ...
            # "((dphi_jtt<0.)*(dphi_jtt+2*{0})+(dphi_jtt>0)*(dphi_jtt)-{0})(125,-3.142, 3.142)".format(np.pi),
            # "((dphi_jtt<0.)*(dphi_jtt+2*{0})+(dphi_jtt>0)*(dphi_jtt)-{0})(40,-1., 1.)".format(np.pi),
    ...
    extras += " --outputfolder output/{}/DYnlo/ ".format(args.analysis)
    # extras += " --datacard shifted_dphi_jtt_eta{}to{} ".format(args.eta_lo, args.eta_hi)
