TH1D* DrawVBFHist(TString filename){
    ...
    TCut offline = "mjj>1000 & jdeta>2.5 & jpt_1>140 & jpt_2>60 & pt_tt>100 & mva_olddm_medium_1>0.5 & mva_olddm_medium_2>0.5 & antiele_1 & antiele_2 & antimu_1 & antimu_2";
    TCut VBF = "trg_VBF";
